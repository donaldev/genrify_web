...
<html lang="en">
<head>
    <title>Code coverage report for ol/interaction/dragbox.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/interaction/</a> dragbox.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">52.94% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>27/51</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
   ...
   * @private
   */
  this.minArea_ = options.minArea !== undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >options.minArea </span>: 64;
&nbsp;
  /**
   * @type {ol.Pixel}
   * @private
 ...
 */
ol.interaction.DragBox.defaultBoxEndCondition = <span class="fstat-no" title="function not covered" >function(mapBrowserEvent, startPixel, endPixel) {</span>
...
<span class="cstat-no" title="statement not covered" >  return width * width + height * height &gt;= this.minArea_;</span>
};
&nbsp;
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.dispatchEvent(new ol.interaction.DragBox.Event(ol.interaction.DragBox.EventType_.BOXDRAG,</span>
...
<span class="cstat-no" title="statement not covered" >    this.dispatchEvent(new ol.interaction.DragBox.Event(ol.interaction.DragBox.EventType_.BOXEND,</span>
        mapBrowserEvent.coordinate, mapBrowserEvent));
  }
...
<span class="cstat-no" title="statement not covered" >    this.dispatchEvent(new ol.interaction.DragBox.Event(ol.interaction.DragBox.EventType_.BOXSTART,</span>
        mapBrowserEvent.coordinate, mapBrowserEvent));
<span class="cstat-no" title="statement not covered" >    return true;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return false;</span>
 ...
 */
ol.interaction.DragBox.Event = <span class="fstat-no" title="function not covered" >function(type, coordinate, mapBrowserEvent) {</span>
