...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.Map');
&nbsp;
goog.require('ol');
...
&nbsp;
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (ol.ENABLE_CANVAS) {
