...
<html lang="en">
<head>
    <title>Code coverage report for ol/geom/flat/interpolate.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">ol/geom/flat/</a> interpolate.js
    </h1>
    <div class='clearfix'>
...
ol.geom.flat.interpolate.lineString = function(flatCoordinates, offset, end, stride, fraction, opt_dest) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (n !== 0) {
