  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">73.96% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>71/96</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="branch-6 cbranch-no" title="branch not covered" >    case ol.geom.GeometryType.MULTI_POLYGON: {</span>
...
ol.Sphere.getArea = function(geometry, opt_options) {
  ...
  var radius = options.radius || ol.Sphere.DEFAULT_RADIUS;
  var projection = options.projection || <span class="branch-1 cbranch-no" title="branch not covered" >'EPSG:3857';</span>
  geometry = geometry.clone().transform(projection, 'EPSG:4326');
  var type = geometry.getType();
  var area = 0;
  var coordinates, coords, i, ii, j, jj;
...
<span class="branch-4 cbranch-no" title="branch not covered" >    case ol.geom.GeometryType.LINEAR_RING: {</span>
<span class="cstat-no" title="statement not covered" >      break;</span>
    }
<span class="branch-5 cbranch-no" title="branch not covered" >    case ol.geom.GeometryType.POLYGON: {</span>
...
<span class="branch-7 cbranch-no" title="branch not covered" >    case ol.geom.GeometryType.GEOMETRY_COLLECTION: {</span>
