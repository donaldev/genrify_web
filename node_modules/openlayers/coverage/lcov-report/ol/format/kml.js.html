...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/kml.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> kml.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.8% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>893/952</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">75.85% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>311/410</span>
      </div>
      <div class='fl pad1y space-right2'>
...
3081
3082
3083</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">214×</span>
<span class="cline-any cline-yes">214×</span>
<span class="cline-any cline-yes">13798×</span>
<span class="cline-any cline-yes">13798×</span>
<span class="cline-any cline-yes">13798×</span>
<span class="cline-any cline-yes">13798×</span>
<span class="cline-any cline-yes">13798×</span>
...
ol.format.KML.createNameStyleFunction_ = function(foundStyle, name) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (foundStyle.getImage()) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (imageSize === null) {
      imageSize = ol.format.KML.DEFAULT_IMAGE_STYLE_SIZE_;
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (imageSize.length == 2) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (foundStyle.getText() !== null) {
    // clone the text style, customizing it with name, alignments and offset.
    // Note that kml does not support many text options that OpenLayers does (rotation, textBaseline).
    var foundText = foundStyle.getText();
    textStyle = foundText.clone();
    textStyle.setFont(foundText.getFont() || <span class="branch-1 cbranch-no" title="branch not covered" >ol.format.KML.DEFAULT_TEXT_STYLE_.getFont())</span>;
    textStyle.setScale(foundText.getScale() || <span class="branch-1 cbranch-no" title="branch not covered" >ol.format.KML.DEFAULT_TEXT_STYLE_.getScale())</span>;
    textStyle.setFill(foundText.getFill() || <span class="branch-1 cbranch-no" title="branch not covered" >ol.format.KML.DEFAULT_TEXT_STYLE_.getFill())</span>;
    textStyle.setStroke(foundText.getStroke() || <span class="branch-1 cbranch-no" title="branch not covered" >ol.format.KML.DEFAULT_TEXT_STROKE_STYLE_)</span>;
  } else {
<span class="cstat-no" title="statement not covered" >    textStyle = ol.format.KML.DEFAULT_TEXT_STYLE_.clone();</span>
  }
...
ol.format.KML.readURI_ = function(node) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (node.baseURI &amp;&amp; node.baseURI !== 'about:blank') {
...
<span class="cstat-no" title="statement not covered" >    return;</span>
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (href) {
    src = href;
  } else <span class="cstat-no" title="statement not covered" >if (drawIcon) {</span>
...
&nbsp;
  var scale = /** @type {number|undefined} */
      (object['scale']);
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (drawIcon) {
...
<span class="cstat-no" title="statement not covered" >    styleObject['imageStyle'] = ol.format.KML.DEFAULT_NO_IMAGE_STYLE_;</span>
  }
};
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      ol.asserts.assert(false, 37); </span>// Unknown geometry type found
    }
  } else {
    multiGeometry = new ol.geom.GeometryCollection(geometries);
  }
...
<span class="cstat-no" title="statement not covered" >    return null;</span>
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (imageStyle == ol.format.KML.DEFAULT_NO_IMAGE_STYLE_) {
<span class="cstat-no" title="statement not covered" >    imageStyle = undefined;</span>
  }
...
ol.format.KML.DataParser_ = function(node, objectStack) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (featureObject.displayName !== null) {
...
<span class="cstat-no" title="statement not covered" >    ol.asserts.assert(false, 38); </span>// `styleMapValue` has an unknown type
  }
};
&nbsp;
&nbsp;
...
ol.format.KML.whenParser_ = function(node, objectStack) {
  ...
  whens.push(isNaN(when) ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: when);
};
&nbsp;
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >        styleUri = '#' + id;</span>
      }
...
ol.format.KML.prototype.readNameFromDocument = function(doc) {
  ...
  for (n = doc.firstChild; n; n = n.nextSibling) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (n.nodeType == Node.ELEMENT_NODE) {
...
ol.format.KML.prototype.readRegion = function(source) {
  var regions = [];
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isDocument(source)) {
<span class="cstat-no" title="statement not covered" >    ol.array.extend(regions, this.readRegionFromDocument(</span>
        /** @type {Document} */ (source)));
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (ol.xml.isNode(source)) {
<span class="cstat-no" title="statement not covered" >    ol.array.extend(regions, this.readRegionFromNode(</span>
        /** @type {Node} */ (source)));
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof source === 'string') {
    var doc = ol.xml.parse(source);
...
<span class="cstat-no" title="statement not covered" >    ol.asserts.assert(false, 34); </span>// Invalid geometry layout
  }
&nbsp;
  var d, i;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (anchor &amp;&amp; (anchor[0] !== size[0] / 2 || <span class="branch-2 cbranch-no" title="branch not covered" >anchor[1] !== size[1] / 2)</span>) {
...
<span class="cstat-no" title="statement not covered" >    ol.asserts.assert(false, 39); </span>// Unknown geometry type
  }
  ol.xml.pushSerializeAndPop(context,
...
&nbsp;
  ...
  var keys = Object.keys(properties || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.sort().filter(function(v) {
    return !filter[v];
  });
&nbsp;
  if (keys.length &gt; 0) {
...
&nbsp;
  ...
  if (styleFunction) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (styles) {
      var style = Array.isArray(styles) ? styles[0] : <span class="branch-1 cbranch-no" title="branch not covered" >styles;</span>
