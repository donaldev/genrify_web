...
<html lang="en">
<head>
    <title>Code coverage report for ol/format/gpx.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/format/</a> gpx.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.77% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>256/273</span>
      </div>
      <div class='fl pad1y space-right2'>
...
947
948
949</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
ol.format.GPX.writeWptType_ = function(node, coordinate, objectStack) {
  ...
  switch (geometryLayout) {
    case ol.geom.GeometryLayout.XYZM:
      <span class="missing-if-branch" title="else path not taken" >E</span>if (coordinate[3] !== 0) {
        properties['time'] = coordinate[3];
      }
      // fall through
    case ol.geom.GeometryLayout.XYZ:
      <span class="missing-if-branch" title="else path not taken" >E</span>if (coordinate[2] !== 0) {
