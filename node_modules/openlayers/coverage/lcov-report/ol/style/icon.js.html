...
<html lang="en">
<head>
    <title>Code coverage report for ol/style/icon.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/style/</a> icon.js
    </h1>
    <div class='clearfix'>
...
ol.style.Icon.prototype.clone = function() {
  ...
  var newImage;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.iconImage_.getImageState() === ol.ImageState.LOADED) {
  ...
  return new ol.style.Icon({
    ...
    img: newImage ? newImage : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
    imgSize: newImage ? this.iconImage_.getSize().slice() : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
    src: newImage ? undefined : <span class="branch-1 cbranch-no" title="branch not covered" >this.getSrc(),</span>
