...
<html lang="en">
<head>
    <title>Code coverage report for ol/source/urltile.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/source/</a> urltile.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">goog.provide('ol.source.UrlTile');
&nbsp;
goog.require('ol');
 ...
 * @api
 */
ol.source.UrlTile.prototype.getTileLoadFunction = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this.tileLoadFunction;</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @api
 */
ol.source.UrlTile.prototype.setTileLoadFunction = <span class="fstat-no" title="function not covered" >function(tileLoadFunction) {</span>
<span class="cstat-no" title="statement not covered" >  this.tileCache.clear();</span>
<span class="cstat-no" title="statement not covered" >  this.tileLoadFunction = tileLoadFunction;</span>
