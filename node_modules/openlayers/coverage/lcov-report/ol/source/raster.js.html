...
<html lang="en">
<head>
    <title>Code coverage report for ol/source/raster.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ol/source/</a> raster.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.84% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>147/155</span>
      </div>
      <div class='fl pad1y space-right2'>
...
481
482
483</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
  ...
  if (this.renderedImageCanvas_) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (resolution !== renderedResolution || !ol.extent.equals(extent, renderedExtent)) {
<span class="cstat-no" title="statement not covered" >      this.renderedImageCanvas_ = null;</span>
    }
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.renderedImageCanvas_ || this.getRevision() !== this.renderedRevision_) {
...
ol.source.Raster.prototype.onWorkerComplete_ = function(frameState, err, output, data) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (err || !output) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (resolution !== this.requestedFrameState_.viewState.resolution ||
 ...
 * @override
 */
ol.source.Raster.prototype.getImageInternal = <span class="fstat-no" title="function not covered" >function() {</span>
